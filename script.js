window.addEventListener("load", function () {
  _backgroundMusic = document.getElementById("backgroundMusic"); // Audio element
  _backgroundMusicControl = document.querySelector(".backgroundMusicControl"); // Audio toggle button
  _pathItemGoals = document.querySelectorAll(".pathItemGoal"); // All working goals
  _pathGoalPopup = document.querySelector(".pathGoalPopup"); // Popup showing the goal information
